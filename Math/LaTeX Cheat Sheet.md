# Basic Structure
## Starting
`$$` is used to denote the start and end of the LaTeX code block and `LaTeX Suite` allows for input translations from simple language to coding language like **1/x** to **\frac{1}{x}**
$$
\frac{1}{x}
$$
